...
east_decorator = './model/frozen_east_text_detection.pb'
...
def plateROI(image):
    ...
    (scores, geometry) = eastNet.forward(east_output_layers)
...
([startX, startY, endX, endY], text_image) = plateROI(car_image)
